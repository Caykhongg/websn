...
|-------|------|------|-----------|--------|
| frontend-ui-engineer | general | React components, animations, UI | `.opencode/agents/frontend-ui-engineer.md` | Modified `src/` files |
| backend-api-engineer | general | Express API, SQLite, uploads | `.opencode/agents/backend-api-engineer.md` | Modified `backend/` files |
| qa-inspector | general | Validation, regression, quality gate | `.opencode/agents/qa-inspector.md` | `_workspace/qa_report.md` |
